export default {
  ...
  printers: {
    ...
    attachedCamera: {
      printerOptions: 'Opções da impressora',
      label: 'Câmera no cartão',
      off: 'Oculta',
      top: 'Acima',
      bottom: 'Abaixo',
      moveTop: 'Mover a câmera para cima do cartão',
      moveBottom: 'Mover a câmera para baixo do cartão',
      detach: 'Ocultar a câmera do cartão',
    },
    pageView: {
  ...
  makerworld: {
    title: 'Modelos do MakerWorld e Printables',
    description: 'Cole uma URL de modelo do MakerWorld ou Printables para importar os arquivos imprimíveis diretamente no Bambuddy.',
    pasteUrlHeader: 'Importar do MakerWorld ou Printables',
    pasteUrlPlaceholder: 'Cole um link makerworld.com/models/… ou printables.com/model/…',
