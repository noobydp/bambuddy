export default {
  ...
  makerworld: {
    title: 'Modelli MakerWorld e Printables',
    description: 'Incolla l\'URL di un modello MakerWorld o Printables per importare i file stampabili direttamente in Bambuddy.',
    pasteUrlHeader: 'Importa da MakerWorld o Printables',
    pasteUrlPlaceholder: 'Incolla un link makerworld.com/models/… o printables.com/model/…',
