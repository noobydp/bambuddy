export default {
  ...
  makerworld: {
    title: 'MakerWorld 與 Printables 模型',
    description: '貼上 MakerWorld 或 Printables 模型連結，即可將可列印檔案直接匯入 Bambuddy。',
    pasteUrlHeader: '從 MakerWorld 或 Printables 匯入',
    pasteUrlPlaceholder: '貼上 makerworld.com/models/… 或 printables.com/model/… 連結',
    resolveButton: '解析',
