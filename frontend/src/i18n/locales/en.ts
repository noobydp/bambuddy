export default {
  ...
  printers: {
    ...
    accessCode: 'Access Code / Device Key',
    model: 'Model',
    ...
    discovery: {
      ...
      scanningSubnet: 'Scanning subnet for supported printers...',
      ...
      customSubnetNote: 'Use a custom subnet if your printer is on a different network than this server. Its service ports must be reachable (Bambu FTP 990/MQTT 8883 or FlashForge API 8898).',
    },
    // AMS Drying
    drying: {
      start: 'Start Drying',
  ...
  makerworld: {
    ...
    description: 'Paste a MakerWorld or Printables model URL to import its printable files directly into Bambuddy.',
    pasteUrlHeader: 'Import from MakerWorld or Printables',
    pasteUrlPlaceholder: 'Paste a makerworld.com/models/… or printables.com/model/… link',
    ...
    disclaimer: 'Model imports use provider web APIs documented by their communities. Bambuddy is not affiliated with or endorsed by MakerWorld, Bambu Lab, Printables, or Prusa Research.',
