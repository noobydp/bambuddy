export default {
  ...
  makerworld: {
    title: 'MakerWorld と Printables のモデル',
    description: 'MakerWorld または Printables のモデル URL を貼り付けて、印刷可能なファイルを Bambuddy に直接インポートします。',
    pasteUrlHeader: 'MakerWorld または Printables からインポート',
    pasteUrlPlaceholder: 'makerworld.com/models/… または printables.com/model/… のリンク',
    resolveButton: '読み込む',
