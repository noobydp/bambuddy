export default {
  ...
  printers: {
    ...
    flashforge: {
      finishedClearPlate: '打印完成，请清空打印板',
      clearFinished: '确认打印已完成',
      clearOk: '清空 / 确定',
      reprintFinished: '重新打印已完成的任务',
      reprint: '重新打印',
      reprintConfirmTitle: '重新打印已完成的任务？',
      reprintConfirmMessage: '这将关闭完成界面并立即重新开始同一个已保存文件。继续前请确认打印板已清空。',
      reprinting: '正在开始重新打印...',
    },
    // Queue info
    queue: {
  ...
  makerworld: {
    title: 'MakerWorld 与 Printables 模型',
    description: '粘贴 MakerWorld 或 Printables 模型链接，即可将可打印文件直接导入 Bambuddy。',
    pasteUrlHeader: '从 MakerWorld 或 Printables 导入',
    pasteUrlPlaceholder: '粘贴 makerworld.com/models/… 或 printables.com/model/… 链接',
    resolveButton: '解析',
