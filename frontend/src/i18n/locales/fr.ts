export default {
  ...
  makerworld: {
    title: 'Modèles MakerWorld et Printables',
    description: 'Collez une URL de modèle MakerWorld ou Printables pour importer directement ses fichiers imprimables dans Bambuddy.',
    pasteUrlHeader: 'Importer depuis MakerWorld ou Printables',
    pasteUrlPlaceholder: 'Collez un lien makerworld.com/models/… ou printables.com/model/…',
